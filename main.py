...
def spammer():
    ...
    print(f'{Fore.BLUE}                developer by : ! ! Ls sever#0001 << Discord                                                       {Fore.RESET}')
    print(f'{Fore.BLUE}                Discord Link >> https://aztra.xyz/invite/f5zd2wFM                                                 {Fore.RESET}')
    print(f'{Fore.LIGHTCYAN_EX}                                                                                                          {Fore.RESET}')
    
    print(
        f'{Fore.BLUE}                                     [1]{Fore.RESET}{Fore.LIGHTBLUE_EX}  Joiner {Fore.RESET}{Fore.BLUE}                [7]{Fore.RESET}{Fore.LIGHTBLUE_EX}  Token Onliner{Fore.RESET}')
    print(
        f'{Fore.BLUE}                                     [2]{Fore.RESET}{Fore.LIGHTBLUE_EX}  Leaver {Fore.RESET}{Fore.BLUE}                [8]{Fore.RESET}{Fore.LIGHTBLUE_EX}  Token Checker{Fore.RESET}')
    print(
        f'{Fore.BLUE}                                     [3]{Fore.RESET}{Fore.LIGHTBLUE_EX}  Spammer {Fore.RESET}{Fore.BLUE}               [9]{Fore.RESET}{Fore.LIGHTBLUE_EX}  Server Nuker{Fore.RESET}')
    print(
        f'{Fore.BLUE}                                     [4]{Fore.RESET}{Fore.LIGHTBLUE_EX}  Friend Spammer {Fore.RESET}{Fore.BLUE}        [10]{Fore.RESET}{Fore.LIGHTBLUE_EX} Account Nuker{Fore.RESET}')
    print(
        f'{Fore.BLUE}                                     [5]{Fore.RESET}{Fore.LIGHTBLUE_EX}  Webhook Spammer {Fore.RESET}{Fore.BLUE}       [11]{Fore.RESET}{Fore.LIGHTBLUE_EX} About{Fore.RESET}')
    print(
        f'{Fore.BLUE}                                     [6]{Fore.RESET}{Fore.LIGHTBLUE_EX}  DM Spammer {Fore.RESET}{Fore.BLUE}            [12]{Fore.RESET}{Fore.LIGHTBLUE_EX} Exit{Fore.RESET}')
        ...
        def DMSpammer(id, message, token):
            ...
            while True:
                ...
                if r2.status_code == 429:
                    ...
                    print(f"{Fore.LIGHTGREEN_EX}[+] {Fore.RESET}DM sent to {id}!")
    ...
    if choice == '7':
        print(f'{Fore.BLUE}[1]{Fore.RESET}{Fore.LIGHTBLUE_EX} Online{Fore.RESET}')
        print(f'{Fore.BLUE}[2]{Fore.RESET}{Fore.LIGHTBLUE_EX} Do Not Disturb{Fore.RESET}')
        print(f'{Fore.BLUE}[3]{Fore.RESET}{Fore.LIGHTBLUE_EX} Idle{Fore.RESET}')
        onlinr = int(input(f'{Fore.BLUE}[?]> {Fore.LIGHTBLUE_EX}'))
    ...
    if choice == '9':
        ...
        print(f'{Fore.BLUE}[1]{Fore.RESET}{Fore.LIGHTBLUE_EX} Account server Nuker{Fore.RESET}')
        print(f'{Fore.BLUE}[2]{Fore.RESET}{Fore.LIGHTBLUE_EX} Bot server Nuker{Fore.RESET}')

        choicee1 = input(f'{Fore.BLUE}[?]> {Fore.LIGHTBLUE_EX}')

        if choicee1 == '1':
            token = input('Account Token: ')
            print(f'{Fore.BLUE}[1] {Fore.RESET}{Fore.LIGHTBLUE_EX}Nuker{Fore.RESET}')
            print(f'{Fore.BLUE}[2] {Fore.RESET}{Fore.LIGHTBLUE_EX}MassBan/MassKick{Fore.RESET}')
            choicr = input(f'{Fore.BLUE}[?]> {Fore.LIGHTBLUE_EX}')
            ...
            if choicr == '2':
                ...
                class MassBan:
                    ...
                    async def Menu(self):
                        print(f'{Fore.BLUE}[1]{Fore.RESET}{Fore.LIGHTBLUE_EX} MassBan{Fore.RESET}')
                        print(f'{Fore.BLUE}[2]{Fore.RESET}{Fore.LIGHTBLUE_EX} MassKick{Fore.RESET}')
        ...
        if choicee1 == '2':
            ...
            MAX_CHANNELS = 500
            print(f'{Fore.BLUE}[1]{Fore.RESET}{Fore.LIGHTBLUE_EX} Nuke{Fore.RESET}')
            print(f'{Fore.BLUE}[2]{Fore.RESET}{Fore.LIGHTBLUE_EX} MassBan{Fore.RESET}')

            choicee = input(
                f'{Fore.BLUE}[?]> {Fore.LIGHTBLUE_EX}')
    ...
    if choice == '10':
        ...
        print(f'''{Fore.BLUE}[1]{Fore.RESET}{Fore.LIGHTBLUE_EX} Server spam{Fore.RESET}
{Fore.BLUE}[2]{Fore.RESET}{Fore.LIGHTBLUE_EX} Remove all friends{Fore.RESET}
{Fore.BLUE}[3]{Fore.RESET}{Fore.LIGHTBLUE_EX} Block all friends{Fore.RESET}
{Fore.BLUE}[4]{Fore.RESET}{Fore.LIGHTBLUE_EX} Spam settings{Fore.RESET}
{Fore.BLUE}[5]{Fore.RESET}{Fore.LIGHTBLUE_EX} Leave all servers{Fore.RESET}
{Fore.BLUE}[6]{Fore.RESET}{Fore.LIGHTBLUE_EX} Close all DMs{Fore.RESET}
{Fore.BLUE}[7]{Fore.RESET}{Fore.LIGHTBLUE_EX} Send mass DM{Fore.RESET}
{Fore.BLUE}[8]{Fore.RESET}{Fore.LIGHTBLUE_EX} Delete all personal Servers{Fore.RESET}''')
